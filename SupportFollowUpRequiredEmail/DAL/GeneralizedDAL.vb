...
#End Region
    ...
    Public Function ExecuteStoredProcedureGetInteger(ByVal strSPName As String, param As SqlParameter()) As Integer
        Try
            _cmd = GetCommandObject()
            _cmd.Connection = _con
            _cmd.CommandText = strSPName
    ...
    Public Function ExecuteStoredProcedureParaGetInteger(ByVal strSPName As String, ByVal parCollection() As IDataParameter) As Integer
